...
# Load the team_country dictionary
team_country_dict = {
...
'VM Pilot Test':'test',
'TEST-TEAM RDL':'test',
'Volunteering-Team':'DK',
'Test':'test',
'TRY GREEK TRANSLATION':'test',
'TEST_RS_FRI':'test',
'volu':'DK',
'Test_2023':'test',
'Prueba voluntariado':'test',
'testtest':'test',
'Test "You" label':'test',
'Kostopil_City_Volunteers':'Ukraine',
'Rozhyshche_District_Volunteers':'Ukraine',
'Kiev_Darnytskyi District_JointStaffVolunteers':'Ukraine',
'Kiev_Dniprovsky District_JointStaffVolunteers':'Ukraine',
'Kiev_Obolonsky District_JointStaffVolunteers':'Ukraine',
'Kiev_Solomianskyi District_JointStaffVolunteers':'Ukraine',
'Kiev_Podolsky District_JointStaffVolunteers':'Ukraine',
'Korop_District_Volunteers':'Ukraine',
'Komunarska_ City_Volunteers':'Ukraine',
'Pologyvska _ Regional_Volunteers':'Ukraine',
'Zavodsky _ City_Volunteers':'Ukraine',
'Voznesenovsky_City_Volunteers':'Ukraine',
'Volnyansk_ Regional_Volunteers':'Ukraine',
'Kovel_District_Volunteers':'Ukraine',
'Volodymyr-Volynskyi_District_Volunteers':'Ukraine',
'Kamin`-Kashyrskyi_District_Volunteers':'Ukraine',
'Запорізька района філія ЗОО ТЧХУ':'Ukraine',
'Kryvyi Rih_District_ERT_Volunteers':'Ukraine',
'Nikopol_District_ERT_Volunteers':'Ukraine',
'Zolotonosha_District_Volunteers':'Ukraine',
'undconsorten':'corporate',
'prova 2 ':'test',
'Netzwerk Freiwilligkeit - Test':'test',
'SDG Program Team':'DK',
'STAFF-VOLUNTEERS':'DK',
'AF test':'test',
'Polimnios & Antoniou Law':'corporate',
'VM2':'DK',
'Prueba ocac':'DK',
'prueba2':'test',
'prueba':'test',
'CinémaBio':'corporate',
'Test for Intranet':'test',
'Gabriel Test 2023 Aug':'test',
'Test Again':'test',
'Teste Rafa':'test',
'Ivano- Frankivsk Regional| home based care':'Ukraine',
'Ivano-Frankivsk Regional PSS':'Ukraine',
'Ivano-Frankivsk Regional ERT joint|staff|volunteers':'Ukraine',
'Реліф ХОО ТЧХУ':'Ukraine',
'Богодухівська РО':'Ukraine',
'Dnipro_Regional_Staff':'Ukraine',
'Kirovohrad_ Regional_Volunteers':'Ukraine',
'Test SRK Unterwalden':'Switzerland',
'PROYECTO R1 Y R2':'DK',
'Upolu':'Samoa',
'Onufrievska_District_Volunteers':'Ukraine',
'Chernivtsi_Regional_PSS':'Ukraine',
'Chernivtsi_Regional_ERT':'Ukraine',
'Blagovishchenskа_District_Volunteers':'Ukraine',
'Poltava Regional Organization':'Ukraine',
'Myrhorod Local Organization':'Ukraine',
'Lubny Local Organization':'Ukraine',
'Мінна небезпека ХОО ТЧХУ':'Ukraine',
'Poltava MO':'Ukraine',
'Bucha_Filia_Kyiv_Regional_Volunteers 1':'Ukraine',
'Вижницька РО':'Ukraine',
'Tonga - All branches':'Tonga',
'Freiwillige SRK Kantonalverband Unterwalden, Startumfrage':'Switzerland',
'Vanuatu Red Cross Society Volunteers - All branches':'Vanuatu',
'Organizadores':'Mexico',
'Керівництво ХОО ТЧХУ':'Ukraine',
'Шевченківська РО':'Ukraine',
'Київська РО':'Ukraine',
...
'Keski-Helsingin osaston hallitus':'Finland',
'Keski-Helsingin osaston hallitus ':'Finland',
'Medical Staff':'Ukraine',
'Sarny_City_United_Headquarters_of_Volunteers':'Ukraine',
'Stryi District Representation Staff Volunteers':'Ukraine',
'Snihurivka_City_JointStaffVolunteers':'Ukraine',
'Konotop_City_Volunteers':'Ukraine',
'Voznesensk_District_Volunteers\Staff':'Ukraine',
'Bilozerska_District_JointStaffVolunteers':'Ukraine',
'Chernivetska_District_JointStaffVolunteers':'Ukraine',
'Vyzhnytska_District_VolunteersStaff':'Ukraine',
'Oleksandriiska_District_Volunteers':'Ukraine',
'Starokostiantyniv_City_JointStaffVolunteers':'Ukraine',
'Myrhorod Local Organization':'Ukraine',
'Kirovohrad_ Regional_Staff':'Ukraine',
'Київська РО':'Ukraine',
...
'Загін швидкого реагування ХОО ТЧХУ':'Ukraine',
'Гуманітарна допомога ХОО ТЧХУ':'Ukraine',
'Kushugum_Region_Volunteers':'Ukraine',
'Local_ City_Volunteers':'Ukraine',
'Kyiv_Holosiivskyi District_JointStaffVolunteers':'Ukraine',
'Kyiv_Darnytskyi District_JointStaffVolunteers':'Ukraine',
'Kyiv_Desnyanskyi District_JointStaffVolunteers':'Ukraine',
'Kyiv_Dniprovsky District_JointStaffVolunteers':'Ukraine',
'Kyiv_Obolonsky District_JointStaffVolunteers':'Ukraine',
'Kyiv_Svyatoshinsky District_JointStaffVolunteers':'Ukraine',
'Kyiv_Solomianskyi District_JointStaffVolunteers':'Ukraine',
'Kyiv_Shevchenkivskyi District_JointStaffVolunteers':'Ukraine',
'Kyiv_City_Volunteers':'Ukraine',
'Kyiv_City_Staff':'Ukraine',
'Kyiv_Podolsky District_JointStaffVolunteers':'Ukraine',
'Kyiv_Pechersky District_JointStaffVolunteers':'Ukraine',
'Dniprovska_ City_Volunteers':'Ukraine',
'Franskivska & Lychakivska & Syhiv City Representation Staff Volunteers':'Ukraine',
...
# Load the dataframe from ungrouped_ALL.txt
file_path = 'ungrouped_ALL.txt'
df = pd.read_csv(file_path, sep=",", encoding='utf-8')

# clean team names: get rid of ':'
# team names to clean:
# "Cruz Roja Mexicana Delegación Tlalnepantla: Capacitación, Socorros, Voluntariado y Veteranos."
# "Cruz Roja Mexicana Delegación Tlalnepantla: Enfermería, Juventud y Servicio Médico."
# "Cruz Roja Mexicana Delegación Tlalnepantla: Administración, Captación de Fondos, Servicios Generales y Alumnos."
# "SPR Ksnk:n osaston hallitus"
# "Jugendrotkreuz 1:1 Projekte"
# etc.

# Replace colons with hyphens in the "Team Name" column
df['Team Name'] = df['Team Name'].str.replace(':', '-')

# Allocate country to each "Team Name" using the dictionary
df['Country'] = df['Team Name'].map(team_country_dict)

## Allocate a region to each country
# Load the team_country dictionary
country_region_dict = {
'Mexico':'Americas',
'Lebanon':'MENA',
...
'Ecuador':'Americas',
'IFRC network':'Global',
'Asia Pacific network':'Asia-Pacific',
...
# Allocate region to each country using the dictionary
df['Region'] = df['Country'].map(country_region_dict)

# Drop individuals who belong to test teams
